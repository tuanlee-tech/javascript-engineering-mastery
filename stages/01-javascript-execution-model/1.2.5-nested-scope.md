...
<LecturePlayer
  src="/audio/stage-01/1.2.5-nested-scope.aac"
  title="Bài 1.2.5 — Nested Scope"
  subtitle="Nested Functions, Parent Scope & Scope Chain • 23 phút"
/>
...
| Phân biệt shadowing và reassignment/mutation | Debug Lab                   | Tìm root cause "biến bị đổi" trong khi thực ra là shadowing; verify bằng cách kiểm tra global binding không đổi giá trị sau khi hàm chạy |
